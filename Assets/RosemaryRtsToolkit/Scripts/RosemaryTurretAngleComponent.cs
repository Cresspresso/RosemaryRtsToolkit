...
namespace Cresspresso
{
	namespace Rosemary
	{
		public abstract class RosemaryTurretAngleComponent : MonoBehaviour
		{
			/// <summary>
			/// Current angle in degrees, in the range -180 to 180.
			/// </summary>
			...
			/// <seealso cref="angle"/>
			public abstract float CalcAngleFromWorldPoint(Vector3 worldPoint);
